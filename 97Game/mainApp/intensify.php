...
//
//获取所有章节
$sql="SELECT * FROM user_$name WHERE roleid='$roleid'";
...
//更新当前用户表的信息
$sql="UPDATE user_$name SET roleattack=$oldAttack,roledefense=$oldDefense,rolelife=$oldLife,tradeprice=$oldPrice,rolechip=0 WHERE roleid=$roleid";
$result = mysqli_query($conn, $sql);

//查找当前用户表的所有战斗力
$sqlCombat = "SELECT roleattack,roledefense,rolelife FROM user_$name";
